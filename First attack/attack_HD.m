        ...
        for k=K
            ...
            if c(i)==c_faulty(i)
                ...
                if ne>256
                    ...
                    score_joint_HD(k+1) = score_joint_HD(k+1) +log( summation_joint_HD);
                else
...
hold on
plot(mean( Key_rank_ineff(1:no_traces,1:no_key),2),'red','LineWidth',1)
plot(mean (Key_rank_Eff(1:no_traces,:),2),'LineWidth',1)
plot( mean (Key_rank_Faulty(1:no_traces,1:no_key),2),'green','LineWidth',1)
% plot( mean(Key_rank_joint(1:no_traces,:),2),'blue','LineWidth',1)
plot( mean(Key_rank_joint_HD(1:no_traces,1:no_key),2),'blue','LineWidth',1)
% 
% % 
hold off
